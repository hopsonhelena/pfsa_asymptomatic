...
hptest <- read.csv(
  "results/association/hptest/hbb_vs_Pf_no_covariates.hptest.csv",
...
write.table(
  fig3a_output, "results/tables/Figure3A_odds_ratios.tsv",
  sep = "\t", row.names = FALSE, quote = FALSE
)
write.table(
  fig3b, "results/tables/Figure3B_genotype_counts.tsv",
  sep = "\t", row.names = FALSE, quote = FALSE
)
