...
fig2ab <- read.delim("results/tables/Figure2AB_genotype_counts.tsv")
fig2cd <- read.delim("results/tables/Figure2CD_VAF.tsv")
...
ggsave(
  file.path("results/figures", "Figure2.pdf"),
  plot = figure2, device = "pdf",
  width = 178, height = 127, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures", "Figure2A.pdf"),
  plot = dplot, device = "pdf",
  width = 85, height = 65, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures", "Figure2B.pdf"),
  plot = eplot, device = "pdf",
  width = 85, height = 65, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures", "Figure2C.pdf"),
  plot = fplot, device = "pdf",
  width = 85, height = 65, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures", "Figure2D.pdf"),
