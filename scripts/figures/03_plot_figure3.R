...
fig3a_output <- read.delim("results/figures/data/Figure3A_odds_ratios.tsv")
fig3b <- read.delim("results/figures/data/Figure3B_genotype_counts.tsv")
...
ggsave(
  file.path("results/figures/plots", "Figure3.pdf"),
  plot = figure3, device = "pdf",
  width = 178, height = 102, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures/plots", "Figure3A.pdf"),
  plot = top_row, device = "pdf",
  width = 178, height = 50, units = "mm", bg = "white"
)
ggsave(
  file.path("results/figures/plots", "Figure3B.pdf"),
